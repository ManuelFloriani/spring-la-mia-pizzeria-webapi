...
INSERT INTO users (id, email, first_name, last_name, password) VALUES(1, 'test@mail.it', 'mail', 'test', '{noop}password');
INSERT INTO users (id, email, first_name, last_name, password) VALUES(2, 'mariorossi@mail.it', 'mario', 'rossi', '{noop}password');
